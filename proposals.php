<?php
        $page_title="Call for Workshop Proposals";
        include("include/header.php");
?>

<h2 class="hcls">Call For Proposals: ACM SIGCOMM 2012 Workshops</h2>
...
<li>New and returning workshops. For returning workshops, we are waiving the "two-and-out" rule. Workshops that have appeared twice before at SIGCOMM are welcome to apply again.</li>
</ul>
...
<li>The workshop deadlines (internal and external)</li>
